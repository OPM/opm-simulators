...
macro(parse_json_common_params)
  ...
  string(JSON test_args ERROR_VARIABLE err GET ${JSON_STRING} "test_args")
endmacro()
...
macro(parse_json_test_definition idx)
  ...
  string(JSON loc_test_args ERROR_VARIABLE err GET ${test_cases} ${idx} "test_args")
  if (err)
    set(loc_test_args ${test_args})
  endif()
  if (loc_test_args)
    list(APPEND PARAMS TEST_ARGS ${loc_test_args})
  endif()
endmacro()
