...
add_test_compareECLFiles(CASENAME msw_model_1
                         ...
                         REL_TOL ${rel_tol}
                         DIR model1
                         TEST_ARGS --tolerance-pressure-ms-wells=10. --tolerance-wells=1.e-6 --solver-max-time-step-in-days=5.0)
...
add_test_compareECLFiles(CASENAME wsegsicd
			  ...
			  ABS_TOL ${abs_tol}
			  REL_TOL ${rel_tol}
              TEST_ARGS --tolerance-pressure-ms-wells=10. --tolerance-wells=1.e-6 --solver-max-time-step-in-days=1.0 --tolerance-mb=1.e-8 --tolerance-cnv=0.0001 --max-strict-iter=20)
