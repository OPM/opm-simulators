...
public:
    ...
    {
        DUNE_THROW(NotImplemented, "henry coefficient for oxygen in liquid nitrogen");
    };
    ...
    {
        DUNE_THROW(NotImplemented, "diffusion coefficient for liquid oxygen and nitrogen");
    };
};
