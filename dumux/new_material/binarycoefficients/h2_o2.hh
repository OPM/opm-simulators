 ...
 */
#ifndef DUMUX_BINARY_COEFF_H2_O2_HH
#define DUMUX_BINARY_COEFF_H2_O2_HH
...
public:
    ...
    {
        DUNE_THROW(NotImplemented, "henry coefficient for oxygen in liquid hydrogen");
    };
    ...
    {
        DUNE_THROW(NotImplemented, "diffusion coefficient for liquid oxygen and hydrogen");
    };
};
