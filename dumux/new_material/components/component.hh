...
public:
    ...
    { DUNE_THROW(NotImplemented, "Component::name()"); } 

    /*!
     * \brief The mass in [kg] of one mole of the component.
     */
    static Scalar molarMass()
    { DUNE_THROW(NotImplemented, "Component::molarMass()"); } 
    ...
    { DUNE_THROW(NotImplemented, "Component::vaporPressure()"); } 
    ...
    { DUNE_THROW(NotImplemented, "Component::gasViscosity()"); } 

    /*!
     * \brief The dynamic liquid viscosity [N/m^3*s] of the pure component.
     */
    static Scalar liquidViscosity(Scalar temperature, Scalar pressure)
    { DUNE_THROW(NotImplemented, "Component::liquidViscosity()"); } 
