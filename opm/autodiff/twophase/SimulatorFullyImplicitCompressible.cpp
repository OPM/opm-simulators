...
#include <opm/autodiff/twophase/SimulatorFullyImplicitCompressible.hpp>
...
namespace Opm
{
    ...
    class SimulatorFullyImplicitCompressible::Impl
    {
    public:
    ...
    private:
        ...
        // Solvers
        DerivedGeology geo_;
        FullyImplicitCompressibleSolver solver_;
        // Misc. data
    ...
    SimulatorFullyImplicitCompressible::SimulatorFullyImplicitCompressible(const parameter::ParameterGroup& param,
                                                                   const UnstructuredGrid& grid,
                                                                   const BlackoilPropsAdInterface& props,
                                                                   const RockCompressibility* rock_comp_props,
                                                                   WellsManager& wells_manager,
    ...
    SimulatorReport SimulatorFullyImplicitCompressible::run(SimulatorTimer& timer,
                                                        BlackoilState& state,
                                                        WellState& well_state)
    {
    ...
    // \TODO: Treat bcs.
    SimulatorFullyImplicitCompressible::Impl::Impl(const parameter::ParameterGroup& param,
                                               const UnstructuredGrid& grid,
                                               const BlackoilPropsAdInterface& props,
                                               const RockCompressibility* rock_comp_props,
                                               WellsManager& wells_manager,
    ...
    SimulatorReport SimulatorFullyImplicitCompressible::Impl::run(SimulatorTimer& timer,
                                                              BlackoilState& state,
                                                              WellState& well_state)
    {
