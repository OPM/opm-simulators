...
#ifndef OPM_AUTODIFF_VFPINJPROPERTIES_ADB_HPP_
#define OPM_AUTODIFF_VFPINJPROPERTIES_ADB_HPP_
...
public:
     ...
     */
    explicit VFPInjPropertiesAdb(const VFPInjTable* inj_table);
     ...
     */
    explicit VFPInjPropertiesAdb(const std::map<int, VFPInjTable>& inj_tables);
...
#endif /* OPM_AUTODIFF_VFPINJPROPERTIES_ADB_HPP_ */
