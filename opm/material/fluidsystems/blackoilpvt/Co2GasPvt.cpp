...
#define INSTANCE_INT_ENERGY(...) \
    ...
    Co2GasPvt<double>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&, \
...
#define INSTANCE_SAT(...) \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturationPressure<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturatedWaterVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                     const __VA_ARGS__&, \
                                                                     const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::diffusionCoefficient<__VA_ARGS__>(const __VA_ARGS__&, \
                                                         const __VA_ARGS__&, \
                                                         unsigned) const;
...
#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    Co2GasPvt<double>::viscosity<__VA_ARGS__>(unsigned, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturatedViscosity<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturatedInverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                          const __VA_ARGS__&, \
                                                                          const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    Co2GasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
