...
#define INSTANCE_INT_ENERGY(...) \
    ...
    OilPvtMultiplexer<double,true>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                                const __VA_ARGS__&, \
                                                                const __VA_ARGS__&, \
...
#define INSTANCE_SAT_IMPL(T,...) \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::saturatedGasDissolutionFactor<__VA_ARGS__>(unsigned, \
                                                                            const __VA_ARGS__&, \
                                                                            const __VA_ARGS__&, \
                                                                            const __VA_ARGS__&, \
                                                                            const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::saturationPressure<__VA_ARGS__>(unsigned, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::diffusionCoefficient<__VA_ARGS__>(const __VA_ARGS__&, \
                                                                  const __VA_ARGS__&, \
                                                                  unsigned) const;
...
#define INSTANCE_FULL_IMPL(T,...) \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::viscosity<__VA_ARGS__>(unsigned, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::saturatedViscosity<__VA_ARGS__>(unsigned, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                           const __VA_ARGS__&, \
                                                                           const __VA_ARGS__&, \
                                                                           const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::saturatedInverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                                    const __VA_ARGS__&, \
                                                                                    const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    OilPvtMultiplexer<double,T>::saturatedGasDissolutionFactor<__VA_ARGS__>(unsigned, \
