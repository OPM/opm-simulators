...
#define INSTANCE_INT_ENERGY(...) \
    ...
    ConstantCompressibilityWaterPvt<double>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                                         const __VA_ARGS__&, \
                                                                         const __VA_ARGS__&, \
...
#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    ConstantCompressibilityWaterPvt<double>::viscosity<__VA_ARGS__>(unsigned, \
                                                                    const __VA_ARGS__&, \
                                                                    const __VA_ARGS__&, \
                                                                    const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    ConstantCompressibilityWaterPvt<double>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                                       const __VA_ARGS__&, \
                                                                                       const __VA_ARGS__&, \
                                                                                       const __VA_ARGS__&) const;
