...
#define INSTANCE_INT_ENERGY(...) \
    ...
    WetGasPvt<double>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&, \
...
#define INSTANCE_SAT(...) \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturatedWaterVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                     const __VA_ARGS__&, \
                                                                     const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&, \
                                                                   __VA_ARGS__) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturationPressure<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::diffusionCoefficient<__VA_ARGS__>(const __VA_ARGS__&, \
                                                         const __VA_ARGS__&, \
                                                         unsigned) const;
...
#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    WetGasPvt<double>::viscosity<__VA_ARGS__>(unsigned, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&, \
                                              const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturatedViscosity<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&, \
                                                                 const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturatedInverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                          const __VA_ARGS__&, \
                                                                          const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetGasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
