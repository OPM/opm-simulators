...
#define INSTANCE_INT_ENERGY(...) \
  ...
  WaterPvtThermal<double,true>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                            const __VA_ARGS__&, \
                                                            const __VA_ARGS__&, \
...
#define INSTANCE_VOL_FAC(...) \
  template __VA_ARGS__ \
  WaterPvtThermal<double,true>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                          const __VA_ARGS__&, \
                                                                          const __VA_ARGS__&, \
                                                                          const __VA_ARGS__&) const;
INSTANCE_VOL_FAC(double)
INSTANCE_VOL_FAC(DenseAd::Evaluation<double,1,0u>)
INSTANCE_VOL_FAC(DenseAd::Evaluation<double,6,0u>)
INSTANCE_VOL_FAC(DenseAd::Evaluation<double,7,0u>)
INSTANCE_VOL_FAC(DenseAd::Evaluation<double,8,0u>)
INSTANCE_VOL_FAC(DenseAd::Evaluation<double,9,0u>)

#define INSTANCE_FULL(...) \
  template __VA_ARGS__ \
  WaterPvtThermal<double,true>::viscosity<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&) const;
