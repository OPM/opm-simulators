...
#define INSTANCE_INT_ENERGY(...) \
    ...
    WetHumidGasPvt<double>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                        const __VA_ARGS__&, \
                                                        const __VA_ARGS__&, \
...
#define INSTANCE_SAT(...) \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturatedWaterVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                          const __VA_ARGS__&, \
                                                                          const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                        const __VA_ARGS__&, \
                                                                        const __VA_ARGS__&, \
                                                                        const __VA_ARGS__&, \
                                                                        __VA_ARGS__) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturationPressure<__VA_ARGS__>(unsigned, \
                                                            const __VA_ARGS__&, \
                                                            const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::diffusionCoefficient<__VA_ARGS__>(const __VA_ARGS__&, \
                                                              const __VA_ARGS__&, \
                                                              unsigned) const;
INSTANCE_SAT(double)
...
INSTANCE_SAT(DenseAd::Evaluation<double,4,0u>)
INSTANCE_SAT(DenseAd::Evaluation<double,5,0u>)
INSTANCE_SAT(DenseAd::Evaluation<double,6,0u>)

#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::viscosity<__VA_ARGS__>(unsigned, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&, \
                                                   const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturatedViscosity<__VA_ARGS__>(unsigned, \
                                                            const __VA_ARGS__&, \
                                                            const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                      const __VA_ARGS__&, \
                                                                      const __VA_ARGS__&, \
                                                                      const __VA_ARGS__&, \
                                                                      const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturatedInverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                               const __VA_ARGS__&, \
                                                                               const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WetHumidGasPvt<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
