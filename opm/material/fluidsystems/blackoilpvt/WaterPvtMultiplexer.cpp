...
#define INSTANCE_INT_ENERGY(...) \
    ...
    WaterPvtMultiplexer<double,true,true>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                                       const __VA_ARGS__&, \
                                                                       const __VA_ARGS__&, \
...
#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    WaterPvtMultiplexer<double,false,true>::viscosity<__VA_ARGS__>(unsigned, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&, \
                                                                   const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WaterPvtMultiplexer<double,true,true>::viscosity<__VA_ARGS__>(unsigned, \
                                                                  const __VA_ARGS__&, \
                                                                  const __VA_ARGS__&, \
                                                                  const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WaterPvtMultiplexer<double,false,true>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                                      const __VA_ARGS__&, \
                                                                                      const __VA_ARGS__&, \
                                                                                      const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    WaterPvtMultiplexer<double,true,true>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                                     const __VA_ARGS__&, \
                                                                                     const __VA_ARGS__&, \
                                                                                     const __VA_ARGS__&) const;
