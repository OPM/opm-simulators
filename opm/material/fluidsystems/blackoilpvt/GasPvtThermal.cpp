...
#define INSTANCE_INT_ENERGY(...) \
    ...
    GasPvtThermal<double>::internalEnergy<__VA_ARGS__>(unsigned, \
                                                       const __VA_ARGS__&, \
                                                       const __VA_ARGS__&, \
...
#define INSTANCE_SAT(...) \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturatedWaterVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                         const __VA_ARGS__&, \
                                                                         const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                       const __VA_ARGS__&, \
                                                                       const __VA_ARGS__&, \
                                                                       const __VA_ARGS__&, \
                                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturationPressure<__VA_ARGS__>(unsigned, \
                                                           const __VA_ARGS__&, \
                                                           const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::diffusionCoefficient<__VA_ARGS__>(const __VA_ARGS__&, \
                                                            const __VA_ARGS__&, \
                                                            unsigned) const;
...
#define INSTANCE_FULL(...) \
    template __VA_ARGS__ \
    GasPvtThermal<double>::viscosity<__VA_ARGS__>(unsigned, \
                                                  const __VA_ARGS__&, \
                                                  const __VA_ARGS__&, \
                                                  const __VA_ARGS__&, \
                                                  const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturatedViscosity<__VA_ARGS__>(unsigned, \
                                                           const __VA_ARGS__&, \
                                                           const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturatedInverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                              const __VA_ARGS__&, \
                                                                              const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::saturatedOilVaporizationFactor<__VA_ARGS__>(unsigned, \
                                                                       ...
                                                                       const __VA_ARGS__&) const; \
    template __VA_ARGS__ \
    GasPvtThermal<double>::inverseFormationVolumeFactor<__VA_ARGS__>(unsigned, \
                                                                     const __VA_ARGS__&, \
                                                                     const __VA_ARGS__&, \
                                                                     const __VA_ARGS__&, \
                                                                     const __VA_ARGS__&) const;
