...
SET_STRING_PROP(FlowTimeSteppingParameters, TimeStepControl, "pid+newtoniteration");
...
SET_INT_PROP(FlowTimeSteppingParameters, TimeStepControlTargetNewtonIterations, 12);
