...
public:
    ...
    LhsEval permFactTransMultiplier(const IntensiveQuantities& intQuants, unsigned elementIdx, Callback& extendEval) const
    {
        ...
        if constexpr (enableSaltPrecipitation) {
            ...
            LhsEval porosityFactor = extendEval(1. - fs.saltSaturation());
            ...
            return extendEval(intQuants.permFactor());
        }
        else {
            return 1.0;
        }
