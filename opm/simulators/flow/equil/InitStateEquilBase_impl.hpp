...
/*
  ...
  copyright holders.
*/
#ifndef OPM_INIT_STATE_EQUIL_BASE_IMPL_HPP
#define OPM_INIT_STATE_EQUIL_BASE_IMPL_HPP
...
InitialStateComputerBase<FluidSystem,
                         Grid,
                         GridView,
                         ElementMapper,
                         CartesianIndexMapper>::
InitialStateComputerBase(const int numCells,
                         const Scalar defaultTemperature,
                         const CartesianIndexMapper& cartMapper,
                         const int num_pressure_points)
    : temperature_(numCells, defaultTemperature)
    , saltConcentration_(numCells)
    , saltSaturation_(numCells)
    , pp_(FluidSystem::numPhases, std::vector<Scalar>(numCells))
    , sat_(FluidSystem::numPhases, std::vector<Scalar>(numCells))
...
template<class FluidSystem,
         ...
         class CartesianIndexMapper>
template<class RMap>
void InitialStateComputerBase<FluidSystem,
                              Grid,
                              GridView,
                              ElementMapper,
                              CartesianIndexMapper>::
...
{
    const int numEquilReg = regionPvtIdx_.size();
...
#endif // OPM_INIT_STATE_EQUIL_BASE_IMPL_HPP
