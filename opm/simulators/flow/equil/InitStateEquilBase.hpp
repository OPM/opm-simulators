 ...
 * \file
 *
 * \brief Base routines for hydrostatic equilibrium-based initialisation,
 *        common to both black-oil and compositional models.
 */
#ifndef OPM_INIT_STATE_EQUIL_BASE_HPP
#define OPM_INIT_STATE_EQUIL_BASE_HPP
...
class InitialStateComputerBase
{
protected:
...
#endif // OPM_INIT_STATE_EQUIL_BASE_HPP
