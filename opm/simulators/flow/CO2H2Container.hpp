 ...
 */
#ifndef OPM_CO2H2_CONTAINER_HPP
#define OPM_CO2H2_CONTAINER_HPP
...
template<class Scalar> struct CO2H2SolutionContainer;

template<class Scalar>
class CO2H2Container
{
...
private:
    ...
    ScalarBuffer cXmfCO2_{};
    ScalarBuffer cXmfH2_{};
    ScalarBuffer cYmfwat_{};
};

} // namespace Opm

#endif // OPM_CO2H2_CONTAINER_HPP
