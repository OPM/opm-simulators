...
private:
    ...
    typename BaseType::ScalarBuffer rs_{};
    typename BaseType::ScalarBuffer rv_{};
    typename BaseType::ScalarBuffer bubblePointPressure_{};
    typename BaseType::ScalarBuffer dewPointPressure_{};
    std::array<typename BaseType::ScalarBuffer, numPhases> invB_{};
    std::array<typename BaseType::ScalarBuffer, numPhases> relativePermeability_{};
