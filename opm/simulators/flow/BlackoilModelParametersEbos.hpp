...
SET_SCALAR_PROP(FlowModelParameters, ToleranceMb, 1e-7);
SET_SCALAR_PROP(FlowModelParameters, ToleranceCnv,1e-3);
SET_SCALAR_PROP(FlowModelParameters, ToleranceCnvRelaxed, 1e9);
SET_SCALAR_PROP(FlowModelParameters, ToleranceWells, 1e-6);
...
SET_INT_PROP(FlowModelParameters, MaxStrictIter, 88);
...
SET_SCALAR_PROP(FlowModelParameters, TolerancePressureMsWells, 0.001*1e5);
