        ...
        if (severity == ConvergenceReport::Severity::NotANumber) {
            ...
            OPM_THROW_PROBLEM(ConvergenceMonitorFailure,
                              fmt::format(
                                  ...
                                  param_.convergence_monitoring_cutoff_
                              ));
        }
    }
...
void
BlackoilModel<TypeTag>::
checkCardPenalty(ConvergenceReport& report, int iteration)
{
    ...
    if (param_.convergence_monitoring_ &&
        (total_penaltyCard_.total() > param_.convergence_monitoring_cutoff_))
    {
