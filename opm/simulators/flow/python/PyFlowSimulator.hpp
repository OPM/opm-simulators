...
#ifndef OPM_PY_FLOW_SIMULATOR_HEADER_INCLUDED
#define OPM_PY_FLOW_SIMULATOR_HEADER_INCLUDED
...
public:
    PyFlowSimulator( const std::string& deckFilename);
    PyFlowSimulator(
