...
struct StandardPreconditioners {
    static void add()
    {
        ...
        F::addCreator("CUILU0OPM", [](const O& op, [[maybe_unused]] const P& prm, const std::function<V()>&, std::size_t, const C& comm) {
            ...
            const bool tune_gpu_kernels = prm.get<bool>("tune_gpu_kernels", true);
            using field_type = typename V::field_type;
            using CuILU0_OPM_Impl = typename gpuistl::CuILU0_OPM_Impl<M, gpuistl::CuVector<field_type>, gpuistl::CuVector<field_type>>;
...
struct StandardPreconditioners<Operator, Dune::Amg::SequentialInformation> {
    static void add()
    {
        ...
        F::addCreator("CUILU0OPM", [](const O& op, [[maybe_unused]] const P& prm, const std::function<V()>&, std::size_t) {
            ...
            const bool tune_gpu_kernels = prm.get<bool>("tune_gpu_kernels", true);
            using field_type = typename V::field_type;
            using CUILU0 = typename gpuistl::CuILU0_OPM_Impl<M, gpuistl::CuVector<field_type>, gpuistl::CuVector<field_type>>;
