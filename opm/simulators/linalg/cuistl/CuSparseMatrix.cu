...
template <class T>
CuSparseMatrix<T>::CuSparseMatrix(CuSparseHandlePtr cuSparseHandle,
    ...
    numberOfRows(numberOfRows)
{
    ...
    OPM_CUSPARSE_SAFE_CALL(cusparseSetMatType(descr_L, CUSPARSE_MATRIX_TYPE_GENERAL));
...
template<typename T>
void CuSparseMatrix<T>::setUpperTriangular()
{
