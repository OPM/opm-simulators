...
#ifndef OPM_ISTLSOLVER_EBOS_PURE_HEADER_INCLUDED
#define OPM_ISTLSOLVER_EBOS_PURE_HEADER_INCLUDED
    ...
    protected:
        ...
        void checkConvergence( const Dune::InverseOperatorResult& result ) const
        {
            ...
            if(result.reduction < parameters_.relaxed_linear_solver_reduction_){
                std::stringstream ss;
                ss<< "Full linear solver tolerance not achived reduction is:" << result.reduction
