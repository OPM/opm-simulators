...
public:
    ...
    //! \param[in] blockSize size of each block matrix (typically 3)
    //!
    GpuSparseMatrixGeneric(const GpuVector<int>& rowIndices,
...
private:
    ...
    cusparseSpMatDescr_t m_matrixDescriptor;
    ...
    // Create and destroy vector descriptors
    void createVectorDescriptors(const GpuVector<T>& x, GpuVector<T>& y, 
