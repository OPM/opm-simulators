   ...
   static const KeywordValidation::PartiallySupportedKeywords<int>partially_supported_keywords_int = {
         {
            "AQUCON",
            {
               {11,{false, [](int x) { return x == 1; }, "VEOPT1 Vertical Equilibrium option one– not used"}}, // VEFRAC
               {12,{false, [](int x) { return x == 1; }, "VEOPI2 Vertical Equilibrium option two– not used"}}, // VEFRACP
            },
         },
         {
            "EHYSTR",
         ...
         },
         {
            "ENDSCALE",
            {
               ...
               {5,{false, [](int x) { return x == 0; }, "MODE depth temperature end-point scaling not supported – value ignored"}}, // COMP_MODE
            },
         },
         {
            "EQLDIMS",
         ...
         },
         {
            "GRIDFILE",
            {
               {1,{false, [](int x) { return x == 0; }, "NGRID only default value of 0 supported – will continue"}}, // GRID
               {2,{false, [](int x) { return x == 1; }, "NEGRID only default value of 1 supported – will continue"}}, // EGRID
            },
         },
         {
            "NETWORK",
         ...
         },
         {
            "NNC",
            {
               {8,{false, [](int x) { return x == 0; }, "ISATNUM1 only default value of 0 supported – will continue"}}, // SIM_DEPENDENT1
               {9,{false, [](int x) { return x == 0; }, "ISATNUM2 only default value of 0 supported – will continue"}}, // SIM_DEPENDENT2
               {10,{false, [](int x) { return x == 0; }, "IPRSNUM1 only default value of 0 supported – will continue"}}, // PRESSURE_TABLE1
               {11,{false, [](int x) { return x == 0; }, "IPRSNUM2 only default value of 0 supported – will continue"}}, // PRESSURE_TABLE2
               {17,{false, [](int x) { return x == 0; }, "PERMNNC only default value of 0 supported – will continue"}}, // VDFLOW_PERM
            },
         },
         {
            "NUMRES",
         ...
         },
         {
            "SPECGRID",
            {
               {4,{false, [](int x) { return x == 1; }, "NUMRES must be greater than or equal to 1"}}, // NUMRES
            },
         },
         {
            "TABDIMS",
            {
               ...
               {15,{false, [](int x) { return x == 0; }, "NTABKT should be defaulted (0) - ignored as not used"}}, // MAX_KVALUE_TABLES
               {16,{false, [](int x) { return x == 0; }, "NTALPHA should be defaulted (0) - ignored as not used"}}, // NTALPHA
               {17,{false, [](int x) { return x == 10; }, "NASPKA should be defaulted (10) - ignored as not used"}}, // ASPHALTENE_ASPKDAM_MAX_ROWS
               {18,{false, [](int x) { return x == 10; }, "MXRAWG should be defaulted (10) - ignored as not used"}}, // ASPHALTENE_ASPREWG_MAX_ROWS
               {19,{false, [](int x) { return x == 10; }, "MXRASO should be defaulted (10) - ignored as not used"}}, // ASPHALTENE_ASPVISO_MAX_ROWS
               {20,{false, allow_values<int> {}, "NOTUSED should be defaulted (1*) - ignored as not used"}}, // ITEM20_NOT_USED
               {21,{false, [](int x) { return x == 5; }, "MCASPP should be defaulted (5) - ignored as not used"}}, // ASPHALTENE_ASPPW2D_MAX_COLUMNS
               {22,{false, [](int x) { return x == 5; }, "MRASPP should be defaulted (5) - ignored as not used"}}, // ASPHALTENE_ASPPW2D_MAX_ROWS
               {23,{false, [](int x) { return x == 5; }, "MXRATF should be defaulted (5) - ignored as not used"}}, // ASPHALTENE_ASPWETF_MAX_ROWS
               {24,{false, [](int x) { return x == 0; }, "MXNKVT should be defaulted (0) - ignored as not used"}}, // NUM_KVALUE_TABLES
         ...
         },
         {
            "UDADIMS",
            {
               {2,{false, [](int x) { return x ==0; }, "IGNORED should be equal to 0 – ignored as not used"}}, // IGNORED
            },
         },
         {
            "UDQPARAM",
            {
               {1,{false, [](int x) { return x == 1; }, "RSEED option not supported – value ignored"}}, // RANDOM_SEED
            },
         },
         {
            "WELLDIMS",
            {
               {5,{false, [](int x) { return x == 5; }, "MXSTAGE option not supported – value ignored"}}, // MAX_STAGES
               {6,{false, [](int x) { return x == 10; }, "MXSTRMS option not supported – value ignored"}}, // MAX_STREAMS
               {7,{false, [](int x) { return x == 5; }, "MXMIS option not supported – value ignored"}}, // MAX_MIXTURES
               {8,{false, [](int x) { return x == 4; }, "MXSEPS option not supported – value ignored"}}, // MAX_SEPARATORS
               {9,{false, [](int x) { return x == 3; }, "MXCOMPS option not supported – value ignored"}}, // MAX_MIXTURE_ITEMS
               {10,{false, [](int x) { return x == 0; }, "MXDOCOMP option not supported – value ignored"}}, // MAX_COMPLETION_X
               {11,{false, [](int x) { return x == 1; }, "MXWSLIST option not supported – value ignored"}}, // MAX_WELLIST_PR_WELL
               {12,{false, [](int x) { return x == 1; }, "MXWLISTS option not supported – value ignored"}}, // MAX_DYNAMIC_WELLIST
               {13,{false, [](int x) { return x == 10; }, "MXWSECD option not supported – value ignored"}}, // MAX_SECONDARY_WELLS
               {14,{false, [](int x) { return x == 201; }, "MXNGPP option not supported – value ignored"}}, // NO_JASON_ENTRY
            },
         },
   };
   ...
   static const KeywordValidation::PartiallySupportedKeywords<double> partially_supported_keywords_double = {
         ...
         },
         {
            "EHYSTR",
            {
               ...
               {12,{false, [](double x) { return x == 0; }, "NOTUSED and is ignored"}}, // threshold_saturation
            },
         },
         {
            "MULTFLT",
            {
               {4,{true, allow_values<double> {}, "FLT-DIF  the diffusivity multiplier option is not supported – will STOP"}}, // REGION_NAME
            },
         },
         {
            "NNC",
            {
               {14,{false, [](double x) { return x == 0; }, "DIFFNNC not supported – will continue"}}, // DIFFUSIVITY
               {15,{false, [](double x) { return x == 0; }, "DISPNNC not supported – will continue"}}, // SIM_DEPENDENT3
               {16,{false, [](double x) { return x == 0; }, "AREANNC not supported – will continue"}}, // VDFLOW_AREA
            },
         },
   };
