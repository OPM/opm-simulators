                        ...
                        DeferredLogger& deferred_logger) const
    {
        ...
        if constexpr (has_zFraction) {
            std::tie(connectionRates[perf][Indices::contiZfracEqIdx],
                ...
                this->connectionRatezFraction(perf_data.solvent_rates[perf],
                                              cq_s, perf_rates.dis_gas,
                                              this->wsolvent(),
                                              intQuants.xVolume(),
                                              intQuants.yVolume());
        }
        ...
        if constexpr (has_brine) {
            connectionRates[perf][Indices::contiBrineEqIdx] =
                this->connectionRateBrine(perf_data.brine_rates[perf],
                                          perf_rates.vap_wat, cq_s,
                                          this->wsalt(),
                                          intQuants.fluidState().saltConcentration());
        }
