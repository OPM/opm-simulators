...
private:
   ...
   // Validate that GCONINJE top-up phases (RESV/VREP) are consistent
    ...
    /// @brief The slave groups and phases whose injection control mode, and
    ///   the slave groups whose production control mode, was last written
    ...
    std::set<std::pair<std::string, Phase>> master_injection_modes_applied_{};
