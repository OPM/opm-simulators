...
namespace Opm {
    ...
    public:
        ...
        void addWellPressureEquations(PressureMatrix& mat,
                                      ...
                                      const SingleWellState<Scalar>& ws) const override;
    ...
    protected:
        ...
        // updating the ws based on well solution dwells
        ...
        void updateWaterThroughput(const double dt, SingleWellState<Scalar>& ws) const override;
        ...
        void checkOperabilityUnderBHPLimit(const SingleWellState<Scalar>& ws,
                                           const Simulator& ebos_simulator,
                                           DeferredLogger& deferred_logger) override;
