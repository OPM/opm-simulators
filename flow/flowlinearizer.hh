 ...
 * \file
 *
 * \copydoc Opm::FlowLinearizer
 */
#ifndef OPM_FLOW_LINEARIZER_HH
#define OPM_FLOW_LINEARIZER_HH
 ...
 *
 * \brief The linearizer class used by the `flow` simulator
 *
 * This class is basically identical to Ewoms::FvBaseLinearizer except that it uses
 * openMP instead of tasklets for multi-threading.
 */
template<class TypeTag>
class FlowLinearizer
{
//! \cond SKIP_THIS
    ...
    FlowLinearizer(const FlowLinearizer&);
//! \endcond
...
private:
    ...
    void updateConstraintsMap_()
    {
        ...
        Ewoms::ThreadedEntityIterator<GridView, /*codim=*/0> threadedElemIt(gridView_());
#ifdef _OPENMP
#pragma omp parallel
#endif
        {
